...
function LoginModal({ isOpen, onClose }) {
    ...
    /* Phone.Email Integration */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Only load script if modal is open to avoid unnecessary resources/listeners when closed
        if (!isOpen) return;
        ...
        // Listener for successful verification
        window.phoneEmailListener = async (userObj)=>{
            const { user_json_url } = userObj;
            setIsLoading(true);
            try {
                const res = await fetch(`${API_URL}/api/auth/verify-phone-token`, {
                    method: 'POST',
                    headers: {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                (step === 1 || step === 2) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                "data-client-id": ("TURBOPACK compile-time value", "16573728609320277030")
                            }, void 0, false, {
                                fileName: "[project]/src/components/LoginModal.js",
                                lineNumber: 101,
                                columnNumber: 17
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "By logging in, you agree to our Terms & Privacy Policy."
                        }, void 0, false, {
                            fileName: "[project]/src/components/LoginModal.js",
                            lineNumber: 109,
                            columnNumber: 13
...
function BookingModal({ isOpen, onClose, service }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetch('http://localhost:5000/api/hospitals').then((res)=>res.json()).then((data)=>setLabs(data)).catch((err)=>console.error(err));
    }, []);
    ...
    const handleBooking = async ()=>{
        ...
        try {
            const bookingData = {
                ...
                time: selectedTime,
                address: user.location || 'New Delhi, India',
...
function HospitalsContent() {
    ...
    const [showLogin, setShowLogin] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    // Enhanced Mock Data Generator covering all categories
    const generateMockData = (cityName)=>[
            // Radiology
            {
                id: 1,
                name: `X-Ray Chest PA View (${cityName})`,
                price: 171,
                reportTime: '24 hrs',
                specialty: 'Radiology'
            },
            {
                id: 2,
                name: `MRI Brain Plain - ${cityName} Imaging`,
                price: 2500,
                reportTime: '36 hrs',
                specialty: 'Radiology'
            },
            ...
            {
                id: 4,
                name: `ECG / EKG (Resting) - ${cityName} Clinic`,
                price: 450,
                reportTime: '12 hrs',
                specialty: 'Cardiac'
            },
            ...
            {
                id: 10,
                name: 'Childhood Vaccination Package',
                price: 2500,
                reportTime: 'Immediate',
                specialty: 'Pediatric'
            },
            ...
            {
                id: 21,
                name: 'Ayurvedic Pulse Diagnosis',
                price: 350,
                reportTime: 'Immediate',
                specialty: 'Ayurveda'
            },
            {
                id: 22,
                name: 'Panchakarma Detox Session',
                price: 2500,
                reportTime: 'Immediate',
                specialty: 'Ayurveda'
            },
            ...
            {
                id: 23,
                name: `Physiotherapy - ${cityName} Healthcare`,
                price: 500,
                reportTime: 'Immediate',
            ...
            {
                id: 24,
                name: 'Back Pain Management Session',
                price: 600,
                reportTime: 'Immediate',
                specialty: 'Physiotherapy'
            },
            ...
            {
                id: 25,
                name: `Full Body Checkup (${cityName} Special)`,
                price: 1499,
                reportTime: '24 hrs',
                specialty: 'General'
            },
    ...
    // Fetch Hospitals on Load (Sensitive to city)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setHospitals(generateMockData(city || 'Local'));
        setLoading(false);
    }, [
        city
    ]);
                        ...
                        children: filteredHospitals.map((hospital)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: selectedHospital?.id === hospital.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            style: {
                                                width: '100%',
                                                padding: '0.6rem',
                                                background: '#fff',
...
//# sourceMappingURL=src_c96b26ee._.js.map