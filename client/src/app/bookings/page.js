                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
                         ...
                         <span style={{ 
                             fontSize: '0.75rem', padding: '2px 8px', borderRadius: '12px',
                              background: booking.status === 'Completed' ? '#f3f4f6' : 
                                          booking.status === 'Cancelled' ? '#fee2e2' : '#dbeafe',
                              color: booking.status === 'Completed' ? '#000' : 
          ...
          <div style={{
              ...
              <div style={{
                  ...
                  <div style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '1.5rem', background: '#fff', borderRadius: '12px', border: '2px dashed #e2e8f0', marginTop: '0.5rem' }}>
                          <img src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(`ZELP-${selectedBooking.id}-${selectedBooking.user_phone}`)}`} alt="Check-in QR Code" style={{ width: '150px', height: '150px', marginBottom: '1rem', borderRadius: '8px' }} />
                          <div style={{ fontSize: '1rem', fontWeight: '700', color: '#111827', textAlign: 'center' }}>Scan to Check-in</div>
                          <div style={{ fontSize: '0.8rem', color: '#6b7280', textAlign: 'center', marginTop: '4px' }}>Present this QR at the reception</div>
                      </div>
                  </div>
              ...
              <div style={{ background: '#fff', width: '100%', maxWidth: '440px', borderRadius: '24px', padding: '2rem', boxShadow: '0 25px 50px -12px rgba(0,0,0,0.25)', position: 'relative' }}>
                  ...
                  <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                        ...
                        <div style={{ width: '220px', height: '220px', margin: '0 auto', background: '#fff', border: '1px solid #f3f4f6', borderRadius: '16px', padding: '10px' }}>
                             <img src="https://suvidha-052a.onrender.com/uploads/Qr.jpg" alt="QR" style={{ width: '100%', height: '100%', objectFit: 'contain' }} onError={(e) => e.target.src = "https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=upi://pay?pa=suvidha@okaxis&pn=Suvidha&cu=INR"} />
                        </div>
                  </div>
