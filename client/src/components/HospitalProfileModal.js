  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Header/Profile Info */}
        <div style={{ background: 'linear-gradient(to right, #ff6f61, #db2777)', padding: '2.5rem 2rem', color: '#fff' }}>
           ...
           <div style={{ marginTop: '1rem', display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={{ background: '#fff', color: '#ff6f61', padding: '4px 8px', borderRadius: '6px', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '4px' }}>
                 <Star size={14} fill="#ff6f61" /> {hospital.rating}
              </div>
