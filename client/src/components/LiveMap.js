...
const pulseIcon = L.divIcon({
    ...
    html: `
        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 40px; height: 40px; background: rgba(0, 0, 0, 0.1); border-radius: 50%; animation: pulse 2s infinite ease-out; pointer-events: none;"></div>
        <div style="width: 16px; height: 16px; border-radius: 50%; background: #000; border: 3px solid white; box-shadow: 0 0 0 1px rgba(0,0,0,0.1); position: relative; z-index: 2; top: 50%; left: 50%; transform: translate(-50%, -50%);"></div>
        <style>
            @keyframes pulse {
