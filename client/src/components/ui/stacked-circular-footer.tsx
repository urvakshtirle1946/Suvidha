...
function StackedCircularFooter() {
    return (
        <div className="w-full flex justify-center pb-8 px-4">
            <footer className="w-full max-w-[1000px] bg-[#0a0a0a] text-white rounded-[24px] py-8 px-8 flex flex-col items-center shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] border border-[#1f1f1f]">
                ...
                {/* Social Icons */}
                <div className="flex justify-center flex-wrap gap-5 text-gray-400 mb-4">
