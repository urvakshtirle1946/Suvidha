...
function StackedCircularFooter() {
    return (
        <div className="w-full flex justify-center pb-8 px-4">
            <footer className="w-full max-w-[1000px] bg-[#0a0a0a] text-white rounded-[24px] py-10 px-6 flex flex-col items-center shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] border border-[#1f1f1f]">

                {/* Logo Section */}
                <div className="flex items-center justify-center gap-2 mb-6">
                    <img src="/Vector (1).svg" alt="Zelp Logo" className="w-[30px] h-[30px]" />
                    <span className="text-[22px] font-bold tracking-tight mt-[2px]">zelp</span>
                </div>

                {/* Social Icons */}
                <div className="flex justify-center flex-wrap gap-6 text-gray-400 mb-6">
                ...
                {/* Built by Urvaksh */}
                <div className="text-center mt-2 mb-[-0.5rem]">
