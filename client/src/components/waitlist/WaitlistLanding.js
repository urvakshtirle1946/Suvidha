      ...
      <>
        ...
        <div style={{ minHeight: '100vh', backgroundColor: '#0a0b14', color: '#fff', fontFamily: 'var(--font-helvetica)', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column' }} className="scroll-container">
          ...
          <div style={{ maxWidth: '800px', width: '100%', margin: '0 auto', padding: '4rem 2rem', position: 'relative', zIndex: 10 }}>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', backgroundColor: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.1)', padding: '0.4rem 0.8rem', borderRadius: '99px', marginBottom: '2.5rem' }}>
              <div style={{ backgroundColor: '#000', borderRadius: '50%', display: 'flex', padding: '2px' }}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
              <span style={{ fontSize: '0.85rem', fontWeight: '600', color: '#000' }}>You&apos;re on the waitlist</span>
            </div>
        ...
        <div style={{ padding: '0 clamp(1.5rem, 5vw, 2.5rem)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div id="hero" style={{ textAlign: 'center', maxWidth: '840px', width: '100%', paddingTop: '0rem', paddingBottom: '1.5rem', marginTop: '-5.5rem' }}>
            ...
            <div className="badge-text" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '0.35rem 1rem', borderRadius: '999px', border: '1px solid rgba(60,40,20,0.18)', color: '#5a3e2b', fontSize: '0.82rem', fontWeight: 500, marginBottom: '1.6rem', letterSpacing: '0.01em', fontFamily: 'var(--font-helvetica)', gap: '0.5rem' }}>
              <span style={{ minWidth: '8px', width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#000', boxShadow: '0 0 10px rgba(0,0,0,0.2)', flexShrink: 0 }}></span>
